@echo off
echo Temperature Converter Program
echo ==============================
echo.
...
if "%choice%"=="1" (
    ...
    "%LOCALAPPDATA%\Programs\Python\Python311\python.exe" temperature_converter.py
    if errorlevel 1 (
    ...
    "%LOCALAPPDATA%\Programs\Python\Python311\python.exe" temperature_converter_cli.py
    if errorlevel 1 (
        echo Error: Python not found or script failed to run
        echo Please make sure Python is installed and in your PATH
        pause
